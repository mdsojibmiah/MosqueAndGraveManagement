...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed top-0 left-0 z-20 h-screen w-64 bg-gradient-to-b from-[#0b1120] via-[#0f172a] to-[#0f172a] p-6 text-white flex flex-col justify-between transition-transform duration-300 ease-in-out
